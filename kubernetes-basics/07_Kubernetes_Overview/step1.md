...
> 💻 명령어 `kubectl get pod [KUBE-SCHEDULER-NAME] --namespace kube-system --output yaml`{{copy}}  
...
> 💻 명령어 `kubectl describe pod [KUBE-SCHEDULER-NAME] --namespace kube-system`{{copy}}  
>[KUBE-SCHEDULER-NAME] 에는 앞에서 조회한 결과 중 Kube-scheculer의 이름을 적어줍니다.
...
> 💻 명령어 `kubectl logs -n kube-system [KUBE-SCHEDULER-NAME]`{{copy}}  
>[KUBE-SCHEDULER-NAME] 에는 앞에서 조회한 결과 중 Kube-scheculer의 이름을 적어줍니다.
